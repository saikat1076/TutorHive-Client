        ...
        <div className="navbar sticky top-0 z-50 backdrop-blur-lg lg:px-5 glass shadow-lg bg-[#E0F7FF] place-items-center">
            ...
            <div className="navbar-start">
                ...
                <motion.div initial={{ x: "100%", color: "#F5F5F5" }} animate={{ x: 0, color: "#03346E" }} transition={{ duration: 3 }} style={{ fontSize: "2rem", fontWeight: "bold" }}>
                    Tutor <motion.span animate={{ color: ['#6499E9', '#C6E7FF'] }} transition={{ duration: 2, delay: 3, repeat: Infinity }}>Hive</motion.span>
                </motion.div>
            </div>
            ...
            <div className="navbar-end space-x-3">
                {user && user?.email ? (
                    <div className="relative group flex flex-row">
                        ...
                        <div className="dropdown dropdown-end">
                            <div tabIndex={0} role="button" className="btn btn-ghost btn-circle avatar">
                                <div className="w-10 rounded-full">
                                    <img src={user?.photoURL || profilePic} alt="User Profile" className="w-10 h-10 rounded-full cursor-pointer" />
                                </div>
                            </div>
                            <ul tabIndex={0} className="menu menu-sm dropdown-content bg-base-100 rounded-box z-[1] mt-3 w-52 p-2 shadow">
                                <li>
                                    <a aria-disabled="true" className="justify-between cursor-not-allowed">
                        ...
                        {/* Logout Button */}
                        <button onClick={logOut} className="btn btn-sm bg-blue-600 my-auto text-white text-sm ml-2">
                            Logout
                        </button>
                    </div>
                ) : (
