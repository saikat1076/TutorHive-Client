...
const FindTutors = () => {
  ...
  const [sortOption, setSortOption] = useState("asc"); // Default sort by ascending price
  ...
  // Handle sorting by price (either ascending or descending)
      ...
      <div className="mb-4 flex justify-center items-center gap-4">
        ...
        <div className="relative">
          <select
            ...
            value={sortOption}
            className="select bg-blue-500 text-white select-bordered w-full max-w-xs"
          >
